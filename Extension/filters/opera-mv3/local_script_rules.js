...
export const localScriptRules = {
    ...
    '(()=>{window.addEventListener("load",(()=>{"function"==typeof window.ilk_part_getir&&window.ilk_part_getir()}));})();': () => {
        try {
            const e = "done";
            if (Window.prototype.toString.f351b8d40d2afd93b0677c325a5c7364 === e) return;
            window.addEventListener("load", (() => {
                "function" == typeof window.ilk_part_getir && window.ilk_part_getir();
            }));
            Object.defineProperty(Window.prototype.toString, "f351b8d40d2afd93b0677c325a5c7364", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "f351b8d40d2afd93b0677c325a5c7364" due to: ' + e);
        }
    },
    ...
    "(()=>{window.googleImaVansAdapter={init(){},dispose(){}};})();": () => {
        try {
            const e = "done";
            if (Window.prototype.toString.d29910135389ecf30b65b1a8008e68ce === e) return;
            window.googleImaVansAdapter = {
                init() {},
                dispose() {}
            };
            Object.defineProperty(Window.prototype.toString, "d29910135389ecf30b65b1a8008e68ce", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "d29910135389ecf30b65b1a8008e68ce" due to: ' + e);
        }
    },
    ...
    "(()=>{window.tracking={setConfig(){},trackPage(){},trackVideoAutoFail(){}}})();": () => {
        try {
            const e = "done";
            if (Window.prototype.toString.b51cf90d959c2614a7b659bc87b17a12 === e) return;
            window.tracking = {
                setConfig() {},
                trackPage() {},
                trackVideoAutoFail() {}
            };
            Object.defineProperty(Window.prototype.toString, "b51cf90d959c2614a7b659bc87b17a12", {
                value: e,
                enumerable: !1,
                writable: !1,
                configurable: !1
            ...
            console.error('Error executing AG js rule with uniqueId "b51cf90d959c2614a7b659bc87b17a12" due to: ' + e);
        }
    },
